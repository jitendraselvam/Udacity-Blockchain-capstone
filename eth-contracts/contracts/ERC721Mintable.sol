...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Only the owner can make calls");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "Token alreay exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from, "Sender does not have the Token");
...
contract JToken is ERC721Metadata("J Token", "JT" , "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
